...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-[#81852B]/10 h-full p-5 rounded-r-xl text-white overflow-y-scroll ${selectedUser ? 'max-md:hidden' : ''}`}>
      <div className='pb-5'>
        <div className='flex items-center justify-between'>
          <img src={assets.logo} alt="logo" className='max-w-40' />
          <div className='relative py-2 group'>
            <img src={assets.menu_icon} alt="menu" className='max-h-4 cursor-pointer' />
            <div className='absolute right-0 top-full z-20 p-5 w-32 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block '>
